...
colData(se)$label <-  str_extract(colnames(se), "(DHT|Veh)_[0-9]")
```

```{r}
plotAssayDensities(se, colour = "treat", trans = "log2")
plotAssayRle(se, trans = "log2", fill = "treat")
plotAssayPCA(se, trans = "log2", colour = "treat", label = "label")
```
